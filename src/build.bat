...
set CommonCompilerFlags=-MTd -nologo -Gm- -GR- -EHa- -Od -Oi -wd4201 -wd4100 -wd4189 -wd4456 -FAsc -Z7 -Fm8080.map
set CommonLinkerFlags= -incremental:no -opt:ref user32.lib Gdi32.lib winmm.lib
REM cl %CommonCompilerFlags% src/8080.cc && 8080.exe rom\invaders
cl %CommonCompilerFlags% W:\chip-8\src\win32_8080.cc /link %CommonLinkerFlags%
REM
