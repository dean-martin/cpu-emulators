; @see: https://web.archive.org/web/20240403034943/http://www.emulator101.com/files/cpudiag.asm
; @see: https://web.archive.org/web/20240118230906/http://www.emulator101.com/full-8080-emulation.html
;***********************************************************************
